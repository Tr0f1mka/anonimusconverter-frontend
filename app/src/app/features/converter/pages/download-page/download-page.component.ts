...
//     if (this.conversionData.targetFormat == ".json") {
...
export class DownloadPageComponent implements OnInit, OnDestroy {
  ...
  /**
   * Генерирует имя файла на основе оригинального и целевого формата
   */
  ...
  /**
   * Скачивает файл - вызывается при нажатии кнопки
   */
